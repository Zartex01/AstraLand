...
public class ShopGUI implements InventoryHolder {
    ...
    private void build() {
        ...
        inv.setItem(4, header(Material.COMMAND_BLOCK, "&d&lOneBlock Shop", "&7Ressources & améliorations"));

        /* ── Outils ── */
        inv.setItem(10, section("&d&lOUTILS"));
        set(11, d(Material.IRON_PICKAXE, "&fPioche de Fer", 60, "&7Eff. I, Sans Brisure I"), 60,
            ench(ench(new ItemStack(Material.IRON_PICKAXE), Enchantment.EFFICIENCY, 1), Enchantment.UNBREAKING, 1));
        set(12, d(Material.DIAMOND_PICKAXE, "&bPioche Diamant", 200, "&7Eff. III, Sans Brisure II"), 200,
            ench(ench(new ItemStack(Material.DIAMOND_PICKAXE), Enchantment.EFFICIENCY, 3), Enchantment.UNBREAKING, 2));
        set(13, d(Material.NETHERITE_PICKAXE, "&5Pioche Nétherite", 500, "&7Eff. V, Fortune III"), 500,
            ench(ench(new ItemStack(Material.NETHERITE_PICKAXE), Enchantment.EFFICIENCY, 5), Enchantment.FORTUNE, 3));
        set(14, d(Material.DIAMOND_AXE, "&bHache Diamant", 180, "&7Tranchant II"), 180,
            ench(new ItemStack(Material.DIAMOND_AXE), Enchantment.SHARPNESS, 2));

        /* ── Ressources ── */
        inv.setItem(19, section("&d&lRESSOURCES"));
        set(20, d(Material.IRON_INGOT, "&7Fer ×16", 50), 50, new ItemStack(Material.IRON_INGOT, 16));
        set(21, d(Material.GOLD_INGOT, "&6Or ×8", 60), 60, new ItemStack(Material.GOLD_INGOT, 8));
        set(22, d(Material.DIAMOND, "&bDiamant ×3", 100), 100, new ItemStack(Material.DIAMOND, 3));
        set(23, d(Material.EMERALD, "&aÉmeraude ×3", 90), 90, new ItemStack(Material.EMERALD, 3));
        set(24, d(Material.NETHERITE_INGOT, "&5Nétherite", 400, "&7Lingot de Nétherite"), 400, new ItemStack(Material.NETHERITE_INGOT));

        /* ── Spéciaux ── */
        inv.setItem(28, section("&d&lSPÉCIAUX"));
        set(29, d(Material.ENDER_PEARL, "&5Perle d'Ender ×4", 80), 80, new ItemStack(Material.ENDER_PEARL, 4));
        set(30, d(Material.GOLDEN_APPLE, "&6Pomme Dorée", 150), 150, new ItemStack(Material.GOLDEN_APPLE));
        set(31, d(Material.ENCHANTED_GOLDEN_APPLE, "&dPomme Enchantée", 800), 800, new ItemStack(Material.ENCHANTED_GOLDEN_APPLE));
        set(32, d(Material.TNT, "&cTNT ×2", 75), 75, new ItemStack(Material.TNT, 2));
        set(33, d(Material.SHULKER_BOX, "&dBoîte Shulker", 300, "&7Stockage transportable"), 300, new ItemStack(Material.SHULKER_BOX));

        /* ── Armures ── */
        inv.setItem(37, section("&d&lARMURES"));
        set(38, d(Material.IRON_CHESTPLATE, "&fKit Fer", 150), 150,
        ...
        set(39, d(Material.DIAMOND_CHESTPLATE, "&bKit Diamant", 400), 400,
        ...
        set(40, d(Material.ELYTRA, "&dÉlytre", 600, "&7Pour explorer!"), 600, new ItemStack(Material.ELYTRA));
        set(41, d(Material.TOTEM_OF_UNDYING, "&dTotem de Résurrection", 500), 500, new ItemStack(Material.TOTEM_OF_UNDYING));
    }
