...
public class ShopGUI implements InventoryHolder {
    ...
    private void build() {
        ...
        inv.setItem(4, header(Material.DIAMOND_SWORD, "&d&lDuels Shop", "&7Prépare-toi avant ton duel ! | &aClic gauche &7: Acheter | &6Clic droit &7: Vendre"));

        /* ── Consommables Combat ── */
        inv.setItem(10, section("&d&lCOMBAT"));
        set(11, d(Material.GOLDEN_APPLE, "&6Pomme Dorée", 200, 0, "&7Régén + Absorption en combat"), 200, 0, new ItemStack(Material.GOLDEN_APPLE));
        set(12, d(Material.ENCHANTED_GOLDEN_APPLE, "&dPomme Enchantée", 800, 0, "&7Puissance maximale !"), 800, 0, new ItemStack(Material.ENCHANTED_GOLDEN_APPLE));
        set(13, d(Material.MUSHROOM_STEW, "&6Soupe de Champignons ×8", 60, 30, "&7Kit Soup — 8 soupes"), 60, 30, new ItemStack(Material.MUSHROOM_STEW, 8));
        set(14, strengthDisplay(150), 150, 0, strengthPot());
        set(15, speedDisplay(120), 120, 0, speedPot());

        /* ── Équipements ── */
        inv.setItem(19, section("&d&lÉQUIPEMENTS"));
        set(20, d(Material.IRON_SWORD, "&fÉpée de Fer Sharp.II", 80, 0, "&7Tranchant II"), 80, 0,
            ench(new ItemStack(Material.IRON_SWORD), Enchantment.SHARPNESS, 2));
        set(21, d(Material.DIAMOND_SWORD, "&bÉpée Diamant Sharp.III", 250, 0, "&7Tranchant III"), 250, 0,
            ench(new ItemStack(Material.DIAMOND_SWORD), Enchantment.SHARPNESS, 3));
        set(22, d(Material.DIAMOND_CHESTPLATE, "&bKit Diamant Prot.II", 300, 0, "&7Protection II"), 300, 0,
        ...
        set(23, d(Material.BOW, "&aArc Puissance II + Recul II", 150, 0, "&7Puissance II, Recul II"), 150, 0,
            ench(ench(new ItemStack(Material.BOW), Enchantment.POWER, 2), Enchantment.PUNCH, 2));
        set(24, d(Material.ARROW, "&eFlèches ×32", 30, 15), 30, 15, new ItemStack(Material.ARROW, 32));

        /* ── Utilitaires ── */
        inv.setItem(28, section("&d&lUTILITAIRES"));
        set(29, d(Material.ENDER_PEARL, "&5Perle d'Ender ×4", 80, 40, "&7Téléportation tactique"), 80, 40, new ItemStack(Material.ENDER_PEARL, 4));
        set(30, d(Material.COOKED_BEEF, "&eSteak ×16", 40, 20), 40, 20, new ItemStack(Material.COOKED_BEEF, 16));
        set(31, d(Material.TOTEM_OF_UNDYING, "&dTotem", 700, 0, "&7Une chance supplémentaire"), 700, 0, new ItemStack(Material.TOTEM_OF_UNDYING));
        set(32, d(Material.SPLASH_POTION, "&cPotion Dégâts II (Splash)", 100, 0, "&7Dégâts instantanés II"), 100, 0, damagePot());
    }
    ...
    private ItemStack strengthDisplay(int price) { return d(Material.POTION, "&cPotion de Force II", price, 0, "&7Force II 2min"); }
